...
source_path = "C:/Users/plus3/OneDrive/Desktop/cards/default/1440/cache/To.png"
template_path = "C:/Users/plus3/OneDrive/Desktop/cards/default/1440/cache/Tc.png"
...
for scale in np.linspace(0.1, 1.5, 100)[::-1]:
    ...
    detected = cv2.matchTemplate(thresh, template, cv2.TM_CCOEFF_NORMED)
    ...
    if found is None or max_val > found[0]:
        ...
        print("found max val: " + str(max_val))
